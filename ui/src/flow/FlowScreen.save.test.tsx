...
/** Saving lives inside edit mode, which is gated on `edit` over the process's
 *  own department (R5) — PUT /api/processes/{pid} re-derives the same thing and
 *  403s a reader. Seeded through `renderAt` rather than served by the stub.
 */
