...
export function EndNode({ data }: NodeProps<Node<FlowNodeData>>) {
  ...
  return (
    <div dir="rtl" className={`bg-ink text-white rounded-full px-5 py-2 text-[12px] font-bold transition-shadow ${data.highlighted ? 'ring-2 ring-violet ring-offset-2 ring-offset-bg' : ''}`}>
