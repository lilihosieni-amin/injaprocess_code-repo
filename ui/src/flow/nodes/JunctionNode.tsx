...
import { JUNCTION_COLOR } from './junction-colors'
...
export function JunctionNode({ data }: NodeProps<Node<FlowNodeData>>) {
  ...
  return (
    <div className="relative w-11 h-11">
      ...
      <div className={`absolute inset-0 rotate-45 rounded-[4px] ${data.highlighted ? 'ring-2 ring-violet ring-offset-2 ring-offset-bg' : ''}`} style={{ background: JUNCTION_COLOR[j.junctionType] }} />
