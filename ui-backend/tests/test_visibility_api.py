...
def test_the_policy_reads_back_d17s_defaults(data_root, tmp_path):
    ...
    assert body["fields"] == {
        ...
        # QF-26's fact switches, defaulting **shown**: they govern the
        # admin's facts view, not the reader view D17's column is about.
        "fact_records": True, "fact_measurements": True,
