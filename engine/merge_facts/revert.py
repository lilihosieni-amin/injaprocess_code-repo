...
A workbook-stub adoption (QF-20) is refused outright rather than
half-restored: `find_match` cannot resolve the incoming record's own
identity (a full spreadsheetId+sheet pair) back to the stub's id — the
