...
- **INV-1:** No identifier is ever created by the language model; IDs are always generated by the system, uniquely, from a single source. An id, once used, is **never reused** — not even after the process it belonged to is permanently deleted.
